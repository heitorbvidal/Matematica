...
var inicio=confirm('Bem-Vindo ao Simulado de Matemática (Parte 2) '+ user);
...
else{ window.alert('Começou o simulado! Dificuldade: Intermediária');
...
p[1] = "Resolva a equação: 16 x 3 = ?";
r[1] = 48;
p[2] = "Resolva a equação: 12 x 7 = ?";
r[2] = 84;
p[3] = "Qual a raiz quadrada de 64 ?";
r[3] = 8;
p[4] = "Resolva a equação: 23 + 5 x 2 = ?";
r[4] = 33;
p[5] = "Resolva a equação: 11² = ?";
r[5] = 121;
...
document.write("<br><br>Simulado de Matemática Intermediário:<br><br>Suas respostas:<br><br>");
document.write("<ol>");
for(var i=1;i<=t;i++)
{
...
else { document.write('<br><br>Parabéns! Você obteve a quantidade de acertos necessários para avançar para a próxima fase, clique no botão "Prosseguir" para iniciar o nível difícil')
document.write('<br><br><a href="questionário3.html"><button>Prosseguir</button></a>')
